...
export function activate(context: ExtensionContext) {
	...
	let clientOptions: LanguageClientOptions = {
		// Activate the server for Spl files
		documentSelector: ['spl'],
		synchronize: {
			// Synchronize the section 'splLanguageServer' of the settings to the server
			configurationSection: 'splLanguageServer',
	...
	let disposable = new LanguageClient('splLanguageServer', 'Language Server', serverOptions, clientOptions).start();
