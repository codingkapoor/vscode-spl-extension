...
var literalNames = [ null, "';'", "':'", "'/'", "'\\'", "'['", "']'", "'('", 
                     "')'", "'>'", "'<'", "'='", "'''", "'.'", "','", null, 
                     null, "'DEFINE'", "'NAMESPACE'", "'REF'", "'DESCRIPTION'", 
...
SplParser.CSV_WITHHEADER = 45;
SplParser.CSV_NOHEADER = 46;
SplParser.NULL_DEF = 47;
SplParser.NS_TYPES = 48;
SplParser.SOLR = 49;
SplParser.LOCK = 50;
SplParser.CONSTRAIN = 51;
SplParser.COLDROP = 52;
SplParser.COLFILL = 53;
SplParser.COLJOIN = 54;
SplParser.COLCOPY = 55;
SplParser.ADD_CONTEXT = 56;
SplParser.COLSPLIT = 57;
SplParser.COLREP = 58;
SplParser.COLMAP = 59;
SplParser.COLCALC = 60;
SplParser.COLCASE = 61;
SplParser.COLELSE = 62;
SplParser.COLEND = 63;
SplParser.COLWHEN = 64;
SplParser.COLCOUNT = 65;
SplParser.COLPRINT = 66;
SplParser.FUNCTION = 67;
SplParser.INT = 68;
SplParser.DT = 69;
SplParser.REGEX = 70;
SplParser.COLCALC_CATCH_ALL = 71;
SplParser.QUOTED_LABEL = 72;
SplParser.SOLRMAPPING_NAME = 73;
SplParser.SOLRMAPPING_DATATYPE = 74;
SplParser.SOLRMAPPING_MULTIVALUED = 75;
SplParser.SOLRMAPPING_UNIQFLDEF = 76;
SplParser.SOLRMAPPING_OMITNORMS = 77;
SplParser.SOLRMAPPING_STORETV = 78;
SplParser.SOLRMAPPING_STORETP = 79;
SplParser.SOLRMAPPING_STORETO = 80;
SplParser.COLMETA_SYSID1 = 81;
SplParser.COLMETA_SYSID2 = 82;
SplParser.COLMETA_SYSID3 = 83;
SplParser.COLMETA_SESSID1 = 84;
SplParser.COLMETA_SESSID2 = 85;
SplParser.COLMETA_SESSID3 = 86;
SplParser.COLMETA_SESS_NAME = 87;
SplParser.COLMETA_SESS_ATTR = 88;
SplParser.COLMETA_SESS_COUNT = 89;
SplParser.COLMETA_FILENAME = 90;
SplParser.COLMETA_TS = 91;
SplParser.COLMETA_LINKED = 92;
SplParser.COLMETA_CONTENT = 93;
SplParser.COLMETA_FRAGMENT_ID = 94;
SplParser.COLMETA_OBSURL = 95;
SplParser.COLMETA_OBSSIZE = 96;
SplParser.COLMETA_UPLOADEDBY = 97;
SplParser.COLMETA_FACET = 98;
SplParser.COLMETA_SEVERITY = 99;
SplParser.COLMETA_UNITS = 100;
SplParser.COLMETA_LABEL = 101;
SplParser.COLMETA_BEGIN_OFFSET = 102;
SplParser.COLMETA_NAMESPACE = 103;
SplParser.COLMETA_TYPE = 104;
SplParser.ALIGNED_BASIC_L = 105;
SplParser.ALIGNED_BASIC_R = 106;
SplParser.ALIGNED_BASIC_C = 107;
SplParser.IDENT = 108;
SplParser.IDENT_DOT = 109;
SplParser.ZERO = 110;
SplParser.EMPTY_QUOTE = 111;
...
SplParser.prototype.table = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 52)) & ~0x1f) == 0 && ((1 << (_la - 52)) & ((1 << (SplParser.COLDROP - 52)) | (1 << (SplParser.COLFILL - 52)) | (1 << (SplParser.COLJOIN - 52)) | (1 << (SplParser.COLCOPY - 52)) | (1 << (SplParser.COLSPLIT - 52)) | (1 << (SplParser.COLREP - 52)) | (1 << (SplParser.COLMAP - 52)) | (1 << (SplParser.COLCASE - 52)) | (1 << (SplParser.COLCOUNT - 52)) | (1 << (SplParser.COLPRINT - 52)) | (1 << (SplParser.COLCALC_CATCH_ALL - 52)))) !== 0)) {
            this.state = 236;
            this.col_op_def();
            this.state = 241;
            this._errHandler.sync(this);
...
SplParser.prototype.column_def = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if(((((_la - 105)) & ~0x1f) == 0 && ((1 << (_la - 105)) & ((1 << (SplParser.ALIGNED_BASIC_L - 105)) | (1 << (SplParser.ALIGNED_BASIC_R - 105)) | (1 << (SplParser.ALIGNED_BASIC_C - 105)))) !== 0)) {
            this.state = 333;
            this.alignment();
        }
...
SplParser.prototype.solr_mapping_attr_name = function() {
    ...
    try {
        ...
        this.state = 428;
        _la = this._input.LA(1);
        if(!(((((_la - 73)) & ~0x1f) == 0 && ((1 << (_la - 73)) & ((1 << (SplParser.SOLRMAPPING_NAME - 73)) | (1 << (SplParser.SOLRMAPPING_DATATYPE - 73)) | (1 << (SplParser.SOLRMAPPING_MULTIVALUED - 73)) | (1 << (SplParser.SOLRMAPPING_UNIQFLDEF - 73)) | (1 << (SplParser.SOLRMAPPING_OMITNORMS - 73)) | (1 << (SplParser.SOLRMAPPING_STORETV - 73)) | (1 << (SplParser.SOLRMAPPING_STORETP - 73)) | (1 << (SplParser.SOLRMAPPING_STORETO - 73)))) !== 0))) {
        this._errHandler.recoverInline(this);
        }
        else {
        	this._errHandler.reportMatch(this);
